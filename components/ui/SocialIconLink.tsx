...
function IconInstagram({ className = "h-5 w-5" }: IconProps): React.ReactElement {
  return (
...
function IconX({ className = "h-5 w-5" }: IconProps): React.ReactElement {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden>
...
function IconLinkedIn({ className = "h-5 w-5" }: IconProps): React.ReactElement {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden>
...
function IconFacebook({ className = "h-5 w-5" }: IconProps): React.ReactElement {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden>
...
function IconYouTube({ className = "h-5 w-5" }: IconProps): React.ReactElement {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden>
...
function IconTikTok({ className = "h-5 w-5" }: IconProps): React.ReactElement {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden>
...
function IconSnapchat({ className = "h-5 w-5" }: IconProps): React.ReactElement {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden>
...
export const icons: Record<SocialKey, (props: IconProps) => React.ReactElement> = {
