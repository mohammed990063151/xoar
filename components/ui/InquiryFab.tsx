  ...
  return (
    ...
    >
      <motion.a
        ...
        className="inquiry-fab-wa relative z-10 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white sm:h-16 sm:w-16"
        ...
        whileTap={{ scale: 0.96 }}
      >
        <span className="inquiry-fab-wa__rings" aria-hidden>
          <span className="inquiry-fab-wa__ring" />
          <span className="inquiry-fab-wa__ring" />
          <span className="inquiry-fab-wa__ring" />
        </span>
        <WhatsAppIcon />
